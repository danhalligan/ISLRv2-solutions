...
A hypergeometric distribution models sampling without replacement from a finite
...
This function maximizes when its gradient is 0. Solving for this gives a MLE of
$\hat\lambda = \sum_{i=1}^n \delta_i / \sum_{i=1}^n y_i$.
